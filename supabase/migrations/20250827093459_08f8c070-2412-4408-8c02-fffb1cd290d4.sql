-- Fix the system_settings duplicate key issue by using UPSERT properly
...
-- Update subscription plans with correct pricing - delete existing and insert new ones
DELETE FROM public.subscription_plans WHERE name IN ('Basic Plan', 'Pro Plan', 'Enterprise');
